...
(function () {
  ...
  // The polyfill must not be executed, if it's already been loaded.
  ...
  // Register keydown handler immediately — don't wait for 'load' event
  // which may have already fired before this polyfill was injected
